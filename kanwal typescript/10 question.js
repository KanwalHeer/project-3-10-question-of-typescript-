...
//3rd Example:
function thePalinsdrom(theString) {
...
const arrays = ["kanwal", "bilawal", "fiza", "bahadur"];
function printArry() {
...
let allArrays = [2, 1, 4, 5, 6, 3, 2, 7, 6, 5, 4, 8, 9];
let uniqueAray = [];
...
//other example:
let allArrays1 = ["kanwal", "heer", "abiha", "ali", "ali", "heer"];
let uniqueAray1 = [];
...
let assendingArray = [3, 5, 2, 1, 6, 7, 8, 4, 3];
...
assendingOrder();
//second example:
let assendingArray1 = [3, 5, 2, 1, 6, 7, 8, 4, 3];
...
let arr1 = [1, 3, 5, 4, 7];
let arr2 = [6, 2, 9, 8, 10];
let sortedArry = [...arr1, ...arr2].sort((a, b) => a - b);
console.log(sortedArry);
//other example:
function sortedArray(arr3, arr4) {
...
console.log(todoList.isCompleted());
//QUESTION # 10:
//Write a TypeScript function to find: number,arr2:number} {
